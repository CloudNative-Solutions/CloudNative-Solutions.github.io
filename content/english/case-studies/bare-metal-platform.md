---
title: "Enterprise Platform on Bare Metal: 84 Apps, 2 Nodes, Zero Cloud Bills"
meta_title: "Case Studies"
description: "How we built an enterprise-grade Kubernetes platform on 2 Intel NUCs with full CNCF stack"
...
Build a production-grade platform that rivals enterprise cloud deployments — on two Intel NUC mini-PCs. No cloud provider, no managed services, no monthly bills. Full GitOps, full observability, full security.
...
- **Storage:** Rook-Ceph distributed storage across both nodes (600GB NVMe, 42% utilized)
...
- **Zero cloud bills** — entire platform on 2x Intel NUC hardware
